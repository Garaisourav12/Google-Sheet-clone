...
let repBtn = document.querySelector('.rep-btn');
let findIp = document.querySelector('#find-ip');
let repBIp = document.querySelector('#rep-ip');
let found = document.querySelector('.count');
